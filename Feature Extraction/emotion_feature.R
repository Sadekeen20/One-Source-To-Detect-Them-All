...
calm <- processFolder('calm')
happy <- processFolder('happy')
sad <- processFolder('sad')
angry <- processFolder('angry')
fearful <- processFolder('fearful')
disgust <- processFolder('disgust')
surprised <- processFolder('surprised')
...
disgust$label <- 7
surprised$label <- 8
data <- rbind(neutral,calm,happy,sad,angry,
				fearful,disgust,surprised)
data$label <- factor(data$label, 
			labels=c('neutral','calm','happy','sad',
